...
use crate::{
    characteristic::{
        administrator_only_access::AdministratorOnlyAccessCharacteristic, audio_feedback::AudioFeedbackCharacteristic,
        current_door_state::CurrentDoorStateCharacteristic, lock_control_point::LockControlPointCharacteristic,
        ...
        logs::LogsCharacteristic, motion_detected::MotionDetectedCharacteristic, version::VersionCharacteristic,
        HapCharacteristic,
    },
    service::HapService,
    HapType,
...
impl LockManagementService {
    ...
    pub fn new(id: u64, accessory_id: u64) -> Self {
        Self {
            ...
            lock_management_auto_security_timeout: Some(LockManagementAutoSecurityTimeoutCharacteristic::new(
                id + 1 + 3 + 2,
                accessory_id,
            )),
