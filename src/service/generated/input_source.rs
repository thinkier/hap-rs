...
use crate::{
    characteristic::{
        configured_name::ConfiguredNameCharacteristic, current_visibility_state::CurrentVisibilityStateCharacteristic,
        identifier::IdentifierCharacteristic, input_device_type::InputDeviceTypeCharacteristic,
        input_source_type::InputSourceTypeCharacteristic, is_configured::IsConfiguredCharacteristic,
        name::NameCharacteristic, target_visibility_state::TargetVisibilityStateCharacteristic, HapCharacteristic,
    },
    service::HapService,
    HapType,
};
