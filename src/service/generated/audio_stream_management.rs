...
use crate::{
    characteristic::{
        ...
        supported_audio_stream_configuration::SupportedAudioStreamConfigurationCharacteristic, HapCharacteristic,
    },
    service::HapService,
    HapType,
};
...
impl AudioStreamManagementService {
    ...
    pub fn new(id: u64, accessory_id: u64) -> Self {
        Self {
            ...
            selected_audio_stream_configuration: SelectedAudioStreamConfigurationCharacteristic::new(
                id + 1 + 1,
                accessory_id,
            ),
            ..Default::default()
