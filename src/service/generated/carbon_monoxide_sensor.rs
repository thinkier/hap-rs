...
use crate::{
    characteristic::{
        ...
        carbon_monoxide_peak_level::CarbonMonoxidePeakLevelCharacteristic, name::NameCharacteristic,
...
impl HapService for CarbonMonoxideSensorService {
    ...
    fn get_characteristics(&self) -> Vec<&dyn HapCharacteristic> {
        #[allow(unused_mut)]
        let mut characteristics: Vec<&dyn HapCharacteristic> = vec![&self.carbon_monoxide_detected];
    ...
    fn get_mut_characteristics(&mut self) -> Vec<&mut dyn HapCharacteristic> {
        #[allow(unused_mut)]
        let mut characteristics: Vec<&mut dyn HapCharacteristic> = vec![&mut self.carbon_monoxide_detected];
