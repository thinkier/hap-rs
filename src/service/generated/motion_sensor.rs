...
use crate::{
    characteristic::{
        motion_detected::MotionDetectedCharacteristic, name::NameCharacteristic,
...
impl HapService for MotionSensorService {
    ...
    fn get_characteristics(&self) -> Vec<&dyn HapCharacteristic> {
        #[allow(unused_mut)]
        let mut characteristics: Vec<&dyn HapCharacteristic> = vec![&self.motion_detected];
    ...
    fn get_mut_characteristics(&mut self) -> Vec<&mut dyn HapCharacteristic> {
        #[allow(unused_mut)]
        let mut characteristics: Vec<&mut dyn HapCharacteristic> = vec![&mut self.motion_detected];
