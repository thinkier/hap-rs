...
use crate::{
    characteristic::{
        configured_name::ConfiguredNameCharacteristic, managed_network_enable::ManagedNetworkEnableCharacteristic,
...
impl WiFiRouterService {
    ...
    pub fn new(id: u64, accessory_id: u64) -> Self {
        Self {
            ...
            network_access_violation_control: NetworkAccessViolationControlCharacteristic::new(
                id + 1 + 2,
                accessory_id,
            ),
