...
use crate::{
    characteristic::{
        current_air_quality::CurrentAirQualityCharacteristic, name::NameCharacteristic,
        nitrogen_dioxide_density::NitrogenDioxideDensityCharacteristic, ozone_density::OzoneDensityCharacteristic,
        ...
        volatile_organic_compound_density::VolatileOrganicCompoundDensityCharacteristic, HapCharacteristic,
    },
    service::HapService,
    HapType,
};
...
impl AirQualitySensorService {
    ...
    pub fn new(id: u64, accessory_id: u64) -> Self {
        Self {
            ...
            volatile_organic_compound_density: Some(VolatileOrganicCompoundDensityCharacteristic::new(
                id + 1 + 5 + 1,
                accessory_id,
            )),
...
impl HapService for AirQualitySensorService {
    ...
    fn get_characteristics(&self) -> Vec<&dyn HapCharacteristic> {
        #[allow(unused_mut)]
        let mut characteristics: Vec<&dyn HapCharacteristic> = vec![&self.current_air_quality];
    ...
    fn get_mut_characteristics(&mut self) -> Vec<&mut dyn HapCharacteristic> {
        #[allow(unused_mut)]
        let mut characteristics: Vec<&mut dyn HapCharacteristic> = vec![&mut self.current_air_quality];
