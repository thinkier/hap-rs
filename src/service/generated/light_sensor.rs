...
use crate::{
    characteristic::{
        current_light_level::CurrentLightLevelCharacteristic, name::NameCharacteristic,
...
impl HapService for LightSensorService {
    ...
    fn get_characteristics(&self) -> Vec<&dyn HapCharacteristic> {
        #[allow(unused_mut)]
        let mut characteristics: Vec<&dyn HapCharacteristic> = vec![&self.current_light_level];
    ...
    fn get_mut_characteristics(&mut self) -> Vec<&mut dyn HapCharacteristic> {
        #[allow(unused_mut)]
        let mut characteristics: Vec<&mut dyn HapCharacteristic> = vec![&mut self.current_light_level];
